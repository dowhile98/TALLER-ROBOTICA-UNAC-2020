...
int main(void){
	...
	arm_biquad_cascade_df1_init_f32(&S,numStages,h,iirDF1F32);
	
	
	startTiming();
	arm_biquad_cascade_df1_f32(&S,singal_1K_5k_10k_15kHz,y,SIGNAL_LENGTH);
	cycle = StopTiming();
